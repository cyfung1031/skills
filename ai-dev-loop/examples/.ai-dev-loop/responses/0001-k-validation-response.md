...
- Evidence: `scripts/validate-template.py`; `modules/VALIDATION.md`; `PACKAGE-MANIFEST.json`; command `python3 scripts/validate-template.py`.
...
- Evidence: `README.md`, `QUICKSTART.md`, `INSTALLATION.md`, `COMPLETE-PACKAGE-GUIDE.md`, `modules/LOOP-HARNESS.md`.
...
|---|---|---|---|---|
| R-0001-01 | Addressed | `scripts/validate-template.py`, `PACKAGE-MANIFEST.json`, `modules/VALIDATION.md` | `python3 scripts/validate-template.py`; expected pass summary | Example output is illustrative, not live evidence |
