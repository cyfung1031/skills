...
When behavior changes, update these together as directly affected: `SKILL.md`, `modules/LOOP-HARNESS.md`, README, quickstart, installation guide, package guide, validation notes, examples, installer, validator, and manifest. Keep examples illustrative and separate from live project state.
