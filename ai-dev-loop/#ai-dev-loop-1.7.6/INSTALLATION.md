...
The installer copies `SKILL.md` and `LOOP-HARNESS.md`, creates `status.md`, installs the concise state checker, and creates `reviews/`, `responses/`, `context/`, `decisions/`, and `scripts/` under `/path/to/project/.ai-dev-loop/`.
...
cp LOOP-HARNESS.md /path/to/project/.ai-dev-loop/LOOP-HARNESS.md
