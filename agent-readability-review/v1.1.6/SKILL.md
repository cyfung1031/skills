...
For code or validators, evidence may be a command result. For wording changes, evidence may be a manual review note. Do not invent telemetry, paths, counts, tool results, or external state.

### Step 8: Check scripts, validators, and harnesses
...
### Step 9: Compress after fixing root causes
...
4. check whether a cleaner version removed guardrails, state notes, silent transitions, terse formats, scope limits, evidence rules, or lightweight verification paths;
